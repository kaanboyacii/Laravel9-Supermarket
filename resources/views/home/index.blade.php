                        ...
                        <div class="latest-prdouct__slider__item">
                            <a href="#" class="latest-product__item">
                                <div class="latest-product__item__pic">
                                    <{{asset('assets')}} /img src="{{asset('assets')}}/img/latest-product/lp-1.jpg" alt="">
                                </div>
                            ...
                            <a href="#" class="latest-product__item">
                                <div class="latest-product__item__pic">
                                    <{{asset('assets')}} /img src="{{asset('assets')}}/img/latest-product/lp-2.jpg" alt="">
                                </div>
                                <div class="latest-product__item__text">
                                    <h6>Crab Pool Security</h6>
                                    <span>$30.00</span>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="blog__item">
                    <div class="blog__item__pic">
                        <{{asset('assets')}} /img src="{{asset('assets')}}/img/blog/blog-1.jpg" alt="">
                    </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="blog__item">
                    <div class="blog__item__pic">
                        <{{asset('assets')}} /img src="{{asset('assets')}}/img/blog/blog-2.jpg" alt="">
                    </div>
                    <div class="blog__item__text">
                        <ul>
                            <li><i class="fa fa-calendar-o"></i> May 4,2019</li>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="blog__item">
                    <div class="blog__item__pic">
                        <{{asset('assets')}} /img src="{{asset('assets')}}/img/blog/blog-3.jpg" alt="">
                    </div>
                    <div class="blog__item__text">
                        <ul>
                            <li><i class="fa fa-calendar-o"></i> May 4,2019</li>
