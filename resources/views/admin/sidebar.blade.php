 ...
 <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="index.html"><img src="{{asset('assets')}}/admin/images/icon/izlogo-remove.png" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                        ...
                        <ul class="metismenu" id="menu">
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li><a href="index2.html">Onaylanmış Siparişler</a></li>
                                    <li><a href="index3.html">Tamamlanmış Siparişler</a></li>
                                    <li><a href="index3.html">İptal Edilmiş Siparişler</a></li>
                                </ul>
                            </li>
